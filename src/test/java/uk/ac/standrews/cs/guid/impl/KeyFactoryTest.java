...
public class KeyFactoryTest {
    ...
    public void shaHex() throws GUIDGenerationException {
        ...
        KeyImpl guid = (KeyImpl) KeyFactory.generateKey(ALGORITHM.SHA1, "abc".getBytes());
    ...
    public void shaBase_64() throws GUIDGenerationException {
        ...
        IGUID guid = (KeyImpl) KeyFactory.generateKey(ALGORITHM.SHA1, "abc".getBytes());
    ...
    public void testGenerateKey() throws GUIDGenerationException {
        IKey k1 = KeyFactory.generateKey();
        IKey k2 = KeyFactory.generateKey();

        // Key generated by SHA1 from string "null".
        AssertJUnit.assertEquals("74234e98afe7498fb5daf1f36ac2d78acc339464f950703b8c019892f982b90b", k1.toString());
    ...
    public void testGenerateKeyWithString() throws GUIDGenerationException {
        IKey k1 = KeyFactory.generateKey(ALGORITHM.SHA1, "null");
        IKey k2 = KeyFactory.generateKey(ALGORITHM.SHA1, "quick brown fox");
        IKey k3 = KeyFactory.generateKey(ALGORITHM.SHA1, "quick brown fox");
