...
public class GUIDFactoryRecreateGUIDsTest {
    ...
    public void recreateGUIDTest() throws GUIDGenerationException {
        IGUID guid = GUIDFactory.recreateGUID("SHA1_16_984816fd329622876e14907634264e6f332e9fb3");
    ...
    public void recreateGUID_SHA1_256_abc_NIST_Test() throws Exception {
        IGUID guid = GUIDFactory.recreateGUID("SHA256_16_ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad");
    ...
    public void recreateGUID_SHA1_abc_NIST_Base64_Test() throws Exception {
        IGUID guid = GUIDFactory.recreateGUID("SHA1_64_qZk+NkcGgWq6PiVxeFDCbJzQ2J0=");
    ...
    public void recreateGUID_SHA256_abc_NIST_Base64_Test() throws Exception {
        ...
        IGUID guid = GUIDFactory.recreateGUID("SHA256_64_ungWv48Bz+pBQUDeXa4iI7ADYaOWF3qctBD/YfIAFa0=");
    ...
    public void recreateGUID_SHA512_abc_NIST_Base64_Test() throws Exception {
        ...
        IGUID guid = GUIDFactory.recreateGUID("SHA512_64_jpWbddrjE9qM9PcoFPwUP493ecbrn3+hcpmurbaIkBhQHSieSQD35DMbmd7EtUM6x9Mp7rbdJlReluVbh0vpCQ==");
    ...
    public void recreateGUID_SHA1_abc_CANON_Test() throws GUIDGenerationException {
        ...
        IGUID guid = GUIDFactory.recreateGUID("SHA1_1_A9993E36-4706-816A-BA3E-25717850C26C9CD0D89D");
